...
urlpatterns = [
    ...
    path('invoices/product_details/', invoice.product_details, name="Product Details"),
    path('invoices/calculate_amount/', invoice.calculate_amount, name="Calculate Amount"),
