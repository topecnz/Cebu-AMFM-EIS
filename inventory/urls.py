...
urlpatterns = [
    ...
    path('add_schedule/', views.add_sched, name="Add Sched"),
    path('edit_schedule/', views.edit_sched, name="Edit Sched"),
    path('delete_schedule/', views.delete_sched, name="Delete Sched"),
    path('get_schedule/', views.get_sched, name="Get Sched"),
    path('changepass/<str:token>/', views.change_password, name="Change Password"),    
    ...
    path('invoices/cancel_invoice/', invoice.cancel_invoice, name="Cancel Invoice"),
